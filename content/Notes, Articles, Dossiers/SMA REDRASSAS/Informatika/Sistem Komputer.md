**Komputer** adalah sebuah [mesin](https://id.wikipedia.org/wiki/Mesin "Mesin") yang dapat [diprogram](https://id.wikipedia.org/wiki/Pemrograman "Pemrograman") untuk memproses [data](https://id.wikipedia.org/wiki/Data "Data")/[informasi](https://id.wikipedia.org/wiki/Informasi "Informasi")—[direpresentasikan dalam bentuk yang dipahaminya](https://id.wikipedia.org/wiki/Kode "Kode")—berdasarkan aturan [aritmetika](https://id.wikipedia.org/wiki/Aritmetika "Aritmetika") atau [logika](https://id.wikipedia.org/wiki/Operator_logika "Operator logika") ([komputasi](https://id.wikipedia.org/wiki/Komputasi "Komputasi")). Komputer juga dicirikan dengan kemampuannya [menyimpan](https://id.wikipedia.org/wiki/Penyimpanan_data_komputer "Penyimpanan data komputer") [program](https://id.wikipedia.org/wiki/Program_komputer "Program komputer") dan data. Demikian pula, istilah **sistem komputer** merujuk pada komputer utuh yang terdiri dari [perangkat keras](https://id.wikipedia.org/wiki/Perangkat_keras "Perangkat keras") dan [perangkat lunak](https://id.wikipedia.org/wiki/Perangkat_lunak "Perangkat lunak") bekerja sama untuk [menjalankan](https://id.wikipedia.org/wiki/Eksekusi_\(komputasi\) "Eksekusi (komputasi)") [aplikasi komputer.](https://id.wikipedia.org/wiki/Aplikasi "Aplikasi")

# Sejarah Komputer
**Sejarah komputer** berawal dari [abad ke-19](https://id.wikipedia.org/wiki/Abad_ke_19), ketika [Charles Babbage](https://id.wikipedia.org/wiki/Charles_Babbage "Charles Babbage") mencoba untuk mendesain komputer mekanik yang bernama [Mesin Analitikal](https://id.wikipedia.org/w/index.php?title=Mesin_Analitikal&action=edit&redlink=1 "Mesin Analitikal (halaman belum tersedia)"). Desain ini menjadi basis kerangka desain komputer sekarang

Secara garis besar, pengembangan komputer terbagi dalam empat generasi:

- **Generasi pertama/komputer tabung vakum (1940-1956)** dimulai ketika komputer digunakan dalam [akademi](https://id.wikipedia.org/wiki/Akademi "Akademi") dan [militer](https://id.wikipedia.org/wiki/Militer "Militer"), seperti [Komputer Atanasoff-Berry](https://id.wikipedia.org/w/index.php?title=Komputer_Atanasoff-Berry&action=edit&redlink=1 "Komputer Atanasoff-Berry (halaman belum tersedia)") dibuat pada tahun [1937](https://id.wikipedia.org/wiki/1937 "1937") untuk menyelesaikan sistem [persamaan linear](https://id.wikipedia.org/wiki/Persamaan_linear "Persamaan linear") dan [komputer Colossus](https://id.wikipedia.org/wiki/Komputer_Colossus "Komputer Colossus") untuk memecahkan kode rahasia [Jerman Nazi](https://id.wikipedia.org/wiki/Jerman_Nazi "Jerman Nazi"). Kemudian, [ENIAC](https://id.wikipedia.org/wiki/ENIAC "ENIAC") yang dibangun pada tahun [1946](https://id.wikipedia.org/wiki/1946 "1946") menjadi komputer pertama untuk tujuan umum. Ketika komputernya dinyalakan untuk pertama kali, [Philadelphia](https://id.wikipedia.org/wiki/Philadelphia "Philadelphia") mengalami [mati listrik](https://id.wikipedia.org/wiki/Mati_listrik "Mati listrik"). Komputer generasi ini menggunakan [tabung vakum](https://id.wikipedia.org/wiki/Tabung_vakum "Tabung vakum") untuk menyimpan data dan ukurannya memakan satu ruangan.
- **Generasi kedua/komputer bertransistor (1956-1963)** dimulai ketika [transistor](https://id.wikipedia.org/wiki/Transistor "Transistor") menggatikan tabung vakum. [UNIVAC](https://id.wikipedia.org/w/index.php?title=UNIVAC&action=edit&redlink=1 "UNIVAC (halaman belum tersedia)") diperkenalkan ke publik tahun [1951](https://id.wikipedia.org/wiki/1951 "1951") untuk penggunaan komersial. Kemudian, pada tahun [1953](https://id.wikipedia.org/wiki/1953 "1953"), [IBM](https://id.wikipedia.org/wiki/IBM "IBM") memulai bisnis komputernya dengan merilis [IBM 650](https://id.wikipedia.org/w/index.php?title=IBM_650&action=edit&redlink=1 "IBM 650 (halaman belum tersedia)") dan [IBM 700](https://id.wikipedia.org/w/index.php?title=IBM_700&action=edit&redlink=1 "IBM 700 (halaman belum tersedia)"). Berbagai [bahasa pemrograman](https://id.wikipedia.org/wiki/Bahasa_pemrograman "Bahasa pemrograman") mulai dikembangkan dan komputer mulai memiliki [memori](https://id.wikipedia.org/wiki/Memori_\(komputer\) "Memori (komputer)") dan [sistem operasi](https://id.wikipedia.org/wiki/Sistem_operasi "Sistem operasi").
- **Generasi ketiga/komputer integrated circuit (1964-1971)** dimulai ketika teknologi transistor meningkat menjadi [sirkuit terpadu](https://id.wikipedia.org/wiki/Sirkuit_terpadu "Sirkuit terpadu"). [Komputer mini](https://id.wikipedia.org/wiki/Komputer_mini "Komputer mini") adalah inovasi yang signifikan dalam generasi ini dan mempengaruhi generasi komputer selanjutnya. [NASA](https://id.wikipedia.org/wiki/NASA "NASA") menggunakan komputer generasi ini untuk melancarkan [Program Apollo](https://id.wikipedia.org/wiki/Program_Apollo "Program Apollo"), seperti [Komputer Bimbingan Apollo](https://id.wikipedia.org/w/index.php?title=Komputer_Bimbingan_Apollo&action=edit&redlink=1 "Komputer Bimbingan Apollo (halaman belum tersedia)") untuk mempermudah kendali [Apollo Command/Service Module](https://id.wikipedia.org/wiki/Apollo_Command/Service_Module "Apollo Command/Service Module"). [Digital Equipment Corporation](https://id.wikipedia.org/wiki/Digital_Equipment_Corporation "Digital Equipment Corporation") menjadi perusahaan komputer nomor dua di belakang IBM dengan komputer [PDP](https://id.wikipedia.org/w/index.php?title=Programmed_Data_Processor&action=edit&redlink=1 "Programmed Data Processor (halaman belum tersedia)") dan [VAX](https://id.wikipedia.org/w/index.php?title=VAX&action=edit&redlink=1 "VAX (halaman belum tersedia)")-nya. Komputer ini membawa ke pengembangan [sistem operasi](https://id.wikipedia.org/wiki/Sistem_operasi "Sistem operasi") yang berpengaruh, [Unix](https://id.wikipedia.org/wiki/Unix "Unix").
- **Generasi keempat/komputer large scale integrated circuit (1971++)** dimulai pada dasawarsa [1970-an](https://id.wikipedia.org/wiki/1970-an "1970-an") ketika penemuan [MOSFET](https://id.wikipedia.org/wiki/MOSFET "MOSFET") dan [integrasi berskala besar](https://id.wikipedia.org/wiki/Sirkuit_terpadu#SSI,_MSI_and_LSI "Sirkuit terpadu") selanjutnya membawa ke pengembangan [mikroprosesor](https://id.wikipedia.org/wiki/Mikroprosesor "Mikroprosesor") di awal [1970-an](https://id.wikipedia.org/wiki/1970-an "1970-an"). [komputer pribadi](https://id.wikipedia.org/wiki/Komputer_pribadi "Komputer pribadi") yang semakin kecil berkat mikroprosesor mulai berkembang, dimulai dari [komputer rumahan](https://id.wikipedia.org/wiki/Komputer_rumah "Komputer rumah") dan [komputer meja](https://id.wikipedia.org/wiki/Komputer_meja "Komputer meja"). Teknologi selanjutnya adalah [laptop](https://id.wikipedia.org/wiki/Laptop "Laptop") dan ponsel cerdas yang sangat fenomenal, membawa berbagai perusahaan teknologi ke dalam [perang paten atas ponsel cerdas](https://id.wikipedia.org/wiki/Perang_telepon_pintar "Perang telepon pintar").

# Komponen Komputer
## Brainware
**Brainware** adalah orang yang menggunakan, memakai ataupun mengoprasikan perangkat [komputer](https://id.wikipedia.org/wiki/Komputer "Komputer"). Contoh dari brainware yaitu [programmer](https://id.wikipedia.org/wiki/Pemrogram "Pemrogram"), [netter](https://id.wikipedia.org/w/index.php?title=Netter&action=edit&redlink=1 "Netter (halaman belum tersedia)") (sebutan untuk orang yang sedang melakukan surfing di internet), serta orang yang sedang menggunakan perangkat komputer. Brainware adalah manusia yang terlibat dalam mengoperasikan atau pemakaian serta mengatur sistem di dalam perangkat komputer. Brainware juga dikenal sebagai [pengguna](https://id.wikipedia.org/wiki/Pengguna "Pengguna") (_user_).

Dapat diartikan juga sebagai perangkat intelektual yang mengoperasikan dan juga mengeksplorasi kemampuan dari perangkat keras [(hardware)](https://id.wikipedia.org/wiki/Perangkat_keras "Perangkat keras") maupun perangkat lunak [(software)](https://id.wikipedia.org/wiki/Perangkat_lunak "Perangkat lunak")

Istilah brainware komputer ditujukan untuk orang yang menggunakan atau mengoperasikan komputer. Secanggih-canggihnya sebuah komputer baik dari segi hardware atau software jika tidak ada brainware yang mengoperasikannya, maka fungsi hardware dan software komputer tersebut tidak akan bisa berjalan secara optimal.
## Hardware
...
## Software
![](https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Operating_system_placement_%28software%29.svg/800px-Operating_system_placement_%28software%29.svg.png)
...
- [Sistem operasi](https://id.wikipedia.org/wiki/Sistem_operasi "Sistem operasi") misalnya [Linux](https://id.wikipedia.org/wiki/Linux "Linux") dan [Windows](https://id.wikipedia.org/wiki/Windows "Windows").
...
- [Perangkat tegar](https://id.wikipedia.org/wiki/Perangkat_tegar "Perangkat tegar") seperti yang dipasang dalam [jam tangan](https://id.wikipedia.org/wiki/Jam_tangan "Jam tangan") digital, dan [pengendali jarak jauh](https://id.wikipedia.org/wiki/Pengendali_jarak_jauh "Pengendali jarak jauh").
- [Perangkat lunak bebas](https://id.wikipedia.org/wiki/Perangkat_lunak_bebas "Perangkat lunak bebas") dan [Perangkat lunak sumber terbuka](https://id.wikipedia.org/wiki/Perangkat_lunak_sumber_terbuka "Perangkat lunak sumber terbuka")
- [Perangkat lunak gratis](https://id.wikipedia.org/wiki/Perangkat_lunak_gratis "Perangkat lunak gratis")
...
**Arsitektur Von Neuman** (atau **Mesin Von neuman**) adalah [arsitektur](https://id.wikipedia.org/wiki/Arsitektur "Arsitektur") yang diciptakan oleh [John von Neumann](https://id.wikipedia.org/wiki/John_von_Neumann "John von Neumann") (1903-1957). Arsitektur ini digunakan oleh hampir semua [komputer](https://id.wikipedia.org/wiki/Komputer "Komputer") saat ini.
...
John Van Neumann seorang ahli matematika yang merupakan konsultan pembuatan ENIAC pada tahun 1945 mencoba memperbaiki kelemahan ENIAC dengan rancangan komputer barunya, bernama **EDVAC** (_Electronic Discrete Variable Computer_) dengan konsep **program tersimpan** ([bahasa Inggris](https://id.wikipedia.org/wiki/Bahasa_Inggris "Bahasa Inggris"): _stored program concept_).

Tahun 1946 komputer dengan stored-program concept dipublikasikasikan, yang kemudian di kenal dengan Komputer IAS (_Computer of Institute for Advanced Studies_). Struktur komputer IAS terlihat pada gambar 2.1. Komputer ini terdiri atas:

- [Memori utama](https://id.wikipedia.org/w/index.php?title=Memori_utama&action=edit&redlink=1 "Memori utama (halaman belum tersedia)"), untuk menyimpan data maupun instruksi.
- [Arithmetic logic unit](https://id.wikipedia.org/wiki/Arithmetic_logic_unit "Arithmetic logic unit") (ALU), untuk mengolah data biner.
- [Control unit](https://id.wikipedia.org/wiki/Control_unit "Control unit"), untuk melakukan interpretasi instruksi – instruksi di dalam memori sehingga adanya eksekusi instruksi tersebut.
- [I/O](https://id.wikipedia.org/wiki/I/O "I/O"), untuk berinteraksi dengan lingkungan luar.
...
- Data (angka, teks, dll.) dan instruksi program disimpan di dalam memori yang sama. Tidak ada pemisahan fisik antara tempat menyimpan data dan program.

2. Memakai konsep arsitektur stored-program

- Program yang dijalankan komputer disimpan dalam memori, bukan diatur secara manual dengan kabel/saklar.
- Hal ini memungkinkan komputer lebih fleksibel, karena bisa diganti instruksinya hanya dengan memuat program baru.
3. Terdiri atas komponen utama:

- Unit pemrosesan pusat (CPU), terdiri dari:

	- Arithmetic Logic Unit (ALU) → melakukan operasi aritmatika dan logika.
	- Control Unit (CU) → mengatur jalannya instruksi, mengambil instruksi dari memori, lalu mengendalikannya.
	
	- Memori utama → menyimpan data dan instruksi.
	- Input/Output (I/O) → media untuk menerima input dari pengguna dan memberikan hasil keluaran.

4. Eksekusi program mengikuti siklus fetch-decode-execute:
- Fetch → mengambil instruksi dari memori.
- Decode → menerjemahkan instruksi.
- Execute → melaksanakan instruksi (misalnya menghitung, menyimpan, atau menampilkan data).
# Sistem Operasi
![]()![[Pasted image 20251010191008.png]]
![](https://upload.wikimedia.org/wikipedia/commons/thumb/b/bf/Flow-diagram-computer-booting-sequences.svg/800px-Flow-diagram-computer-booting-sequences.svg.png)
**[Sistem](https://id.wikipedia.org/wiki/Sistem_komputer "Sistem komputer") operasi** ([bahasa Inggris](https://id.wikipedia.org/wiki/Bahasa_Inggris "Bahasa Inggris"): _operating system_; disingkat **OS**) adalah [perangkat lunak sistem](https://id.wikipedia.org/wiki/Perangkat_lunak_sistem "Perangkat lunak sistem") yang mengatur sumber daya dari [perangkat keras](https://id.wikipedia.org/wiki/Perangkat_keras "Perangkat keras") dan [perangkat lunak](https://id.wikipedia.org/wiki/Perangkat_lunak "Perangkat lunak"), serta sebagai [daemon](https://id.wikipedia.org/wiki/Daemon "Daemon") untuk [program komputer](https://id.wikipedia.org/wiki/Program_komputer "Program komputer"). Tanpa sistem operasi, pengguna tidak dapat menjalankan [aplikasi](https://id.wikipedia.org/wiki/Aplikasi "Aplikasi") pada komputer mereka, kecuali [booting](https://id.wikipedia.org/wiki/Booting "Booting").
